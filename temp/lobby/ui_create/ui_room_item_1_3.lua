...
Button_enter:loadTextureNormal("lobby/resource/RoomList/3.png",0)
Button_enter:loadTexturePressed("lobby/resource/RoomList/3.png",0)
Button_enter:loadTextureDisabled("lobby/resource/RoomList/3.png",0)
...
Image_title:loadTexture("lobby/resource/RoomList/1_3.png",0)
Image_title:setLayoutComponentEnabled(true)
Image_title:setName("Image_title")
Image_title:setTag(304)
