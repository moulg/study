...
-- local add_title_creater = require "game.likuipiyu.ui.ui_jinchabuyu_title"
local auto_exit_scene_hit = require "game.likuipiyu.ui.ui_likuipiyu_leve"
local set_ui_create = require "game.likuipiyu.ui.ui_setUp"
local lock_ctrl_create = require "game.likuipiyu.ui.ui_likuipiyu_lock"

--[[
	游戏主场景
]]
Likuipiyu = class("Likuipiyu",function ()
	local obj = cc.Layer:create()
	return obj
end)
ModuleObjMgr.add_module_obj(Likuipiyu,"Likuipiyu")

-- local get_bullet_sum = 0
-- local send_bullet_sum = 0


function Likuipiyu.create()
	local obj = Likuipiyu.new()
	if obj then
		obj:init()
	end
...
function Likuipiyu:init()
	...
	--子弹对象管理器
	BulletManager.getInstance():init({bonding_size = lk_system_config.bonding_size,})
...
function Likuipiyu:loadConfigData()

	--load data from json file
	-- fish_config  = load_json_file("game/likuipiyu/data/fish_config.json").fish_config
	-- curve_config = load_json_file("game/likuipiyu/data/curve_config.json").curve_config

	fish_config  = require("game/likuipiyu/data/fish_config.lua")
	curve_config = require("game/likuipiyu/data/curve_config.lua")


	reload_module ("game.likuipiyu.data.bonding_box_config")
	reload_module ("game.likuipiyu.data.sprite_ani_config")
	reload_module ("game.likuipiyu.data.voice_config")
	reload_module ("game.likuipiyu.data.action_eff_config")
	reload_module ("game.likuipiyu.data.skill_config")
	reload_module ("game.likuipiyu.data.music_effect_config")
	reload_module ("game.likuipiyu.data.background_music_src_config")
	reload_module ("game.likuipiyu.data.bullet_config")
	reload_module ("game.likuipiyu.data.lk_system_config")
	reload_module ("game.likuipiyu.data.battery_config")
	reload_module ("game.likuipiyu.data.fish_gold_config")
	reload_module ("game.likuipiyu.data.battery_position_config")
	reload_module ("game.likuipiyu.data.fish_label_fnt_config")
	reload_module ("game.likuipiyu.data.background_config")
	reload_module ("game.likuipiyu.data.fish_water_config")
	reload_module ("game.likuipiyu.data.fish_net_config")

	--loading comment
	reload_module ( "game.likuipiyu.common.jc_common_function")
	reload_module ( "game.likuipiyu.common.calculte_rule")
	reload_module ( "game.likuipiyu.common.action_curve")
	reload_module ( "game.likuipiyu.common.fish")
	reload_module ( "game.likuipiyu.common.object_pool")
	reload_module ( "game.likuipiyu.common.bullet")
	reload_module ( "game.likuipiyu.common.bullet_manager")
	reload_module ( "game.likuipiyu.common.battery")
	reload_module ( "game.likuipiyu.common.battery_manager")
	reload_module ( "game.likuipiyu.common.action_creater")
	reload_module ( "game.likuipiyu.common.action_effect_player")
	reload_module ( "game.likuipiyu.common.music_effect_player")
	reload_module ( "game.likuipiyu.common.fish_manager")
	reload_module ( "game.likuipiyu.common.object_effect_world")
	reload_module ( "game.likuipiyu.common.fish_net")
	reload_module ( "game.likuipiyu.common.fish_net_manager")
	reload_module ( "game.likuipiyu.common.fish_gold")
	reload_module ( "game.likuipiyu.common.fish_gold_manager")
	reload_module ( "game.likuipiyu.common.fish_label_fnt")
	reload_module ( "game.likuipiyu.common.fish_label_fnt_manager")
	-- reload_module ( "game.likuipiyu.common.gold_column")
	-- reload_module ( "game.likuipiyu.common.gold_column_action")
	reload_module ( "game.likuipiyu.common.lock_fish")
	reload_module ( "game.likuipiyu.common.simple_fish")
	reload_module ( "game.likuipiyu.common.background_scene")
	reload_module ( "game.likuipiyu.common.background_scene_manager")
	reload_module ( "game.likuipiyu.common.fish_water")
	reload_module ( "game.likuipiyu.common.skill_player")
	reload_module ( "game.likuipiyu.common.skill_item_rotate_score")
	reload_module ( "game.likuipiyu.common.skill_item_line")
	reload_module ( "game.likuipiyu.common.light_model")
end

function Likuipiyu:unloadData()
	fish_config  = {}
	curve_config = {}

	unload_module("game/likuipiyu/data/fish_config.lua")
	unload_module("game/likuipiyu/data/curve_config.lua")

	unload_module("game.likuipiyu.data.bonding_box_config")
	unload_module("game.likuipiyu.data.sprite_ani_config")
	unload_module("game.likuipiyu.data.voice_config")
	unload_module("game.likuipiyu.data.action_eff_config")
	unload_module("game.likuipiyu.data.skill_config")
	unload_module("game.likuipiyu.data.music_effect_config")
	unload_module("game.likuipiyu.data.background_music_src_config")
	unload_module("game.likuipiyu.data.bullet_config")
	unload_module("game.likuipiyu.data.lk_system_config")
	unload_module("game.likuipiyu.data.battery_config")
	unload_module("game.likuipiyu.data.fish_gold_config")
	unload_module("game.likuipiyu.data.battery_position_config")
	unload_module("game.likuipiyu.data.fish_label_fnt_config")
	unload_module("game.likuipiyu.data.background_config")
	unload_module("game.likuipiyu.data.fish_water_config")
	unload_module("game.likuipiyu.data.fish_net_config")

	--loading comment
	unload_module( "game.likuipiyu.common.jc_common_function")
	unload_module( "game.likuipiyu.common.calculte_rule")
	unload_module( "game.likuipiyu.common.action_curve")
	unload_module( "game.likuipiyu.common.fish")
	unload_module( "game.likuipiyu.common.object_pool")
	unload_module( "game.likuipiyu.common.bullet")
	unload_module( "game.likuipiyu.common.bullet_manager")
	unload_module( "game.likuipiyu.common.battery")
	unload_module( "game.likuipiyu.common.battery_manager")
	unload_module( "game.likuipiyu.common.action_creater")
	unload_module( "game.likuipiyu.common.action_effect_player")
	unload_module( "game.likuipiyu.common.music_effect_player")
	unload_module( "game.likuipiyu.common.fish_manager")
	unload_module( "game.likuipiyu.common.object_effect_world")
	unload_module( "game.likuipiyu.common.fish_net")
	unload_module( "game.likuipiyu.common.fish_net_manager")
	unload_module( "game.likuipiyu.common.fish_gold")
	unload_module( "game.likuipiyu.common.fish_gold_manager")
	unload_module( "game.likuipiyu.common.fish_label_fnt")
	unload_module( "game.likuipiyu.common.fish_label_fnt_manager")
	-- unload_module( "game.likuipiyu.common.gold_column")
	-- unload_module( "game.likuipiyu.common.gold_column_action")
	unload_module( "game.likuipiyu.common.lock_fish")
	unload_module( "game.likuipiyu.common.simple_fish")
	unload_module( "game.likuipiyu.common.background_scene")
	unload_module( "game.likuipiyu.common.background_scene_manager")
	unload_module( "game.likuipiyu.common.fish_water")
	unload_module( "game.likuipiyu.common.skill_player")
	unload_module( "game.likuipiyu.common.skill_item_rotate_score")
	unload_module( "game.likuipiyu.common.skill_item_line")
	unload_module( "game.likuipiyu.common.light_model")
end

function Likuipiyu:init_data()
...
function Likuipiyu:init_ui()
	...
	--add back_image
	-- local title_bk_spr = ccui.ImageView:create("game/likuipiyu/resource/other/tiao.png")
	-- title:addChild(title_bk_spr)
	-- title_bk_spr:setLocalZOrder(-10)
	-- local tt_bk_sz = title_bk_spr:getContentSize()
	-- title_bk_spr:setPosition(lk_system_config.scene_size.width/2,lk_system_config.scene_size.height - tt_bk_sz.height/2)
	-- title_bk_spr:setTouchEnabled(true)

	-- self.title_ext_ui = add_title_creater.create()
	-- title:addChild(self.title_ext_ui.root)
	-- self.title_ext_ui.root:setPosition(lk_system_config.scene_size.width/2,lk_system_config.scene_size.height - tt_bk_sz.height/2)
	...
	self.auto_exit_scene_ui.root:setPosition(lk_system_config.scene_size.width/2,lk_system_config.scene_size.height/2)
	...
	-- self.spr_cursor = cc.Sprite:create("game/likuipiyu/resource/other/cursor.png")
	-- self:addChild(self.spr_cursor)
	-- self.spr_cursor:setPosition(lk_system_config.scene_size.width/2,lk_system_config.scene_size.height/2)
	-- self.spr_cursor:setLocalZOrder(3300000)


	self.setup_obj = LikuiSetup.create()
	...
	--
	self.lock_ui.CheckBox_auto_lock:setPosition(lk_system_config.lock_ctrl_pos.x,lk_system_config.lock_ctrl_pos.y)
	...
	self.lock_ui.CheckBox_auto_fire:setPosition(lk_system_config.lock_ctrl_pos.x+220,lk_system_config.lock_ctrl_pos.y)
...
function Likuipiyu:loading()
	self.loading_info_param = {
		...
		ui_info = {
			back_pic 		= "game/likuipiyu/resource/loading/loadingbg.jpg",
			bar_back_pic 	= "game/likuipiyu/resource/loading/loadbg.png",
			bar_process_pic = "game/likuipiyu/resource/loading/loadt.png",
			b_self_release 	= true,
		},
	}
...
function Likuipiyu:loadingImage(percent,index,texture)
...
function Likuipiyu:reloadSetData()
	open_user_config()
...
function Likuipiyu:setGraphicLevel(level)
	if level == 3 then
...
function Likuipiyu:loadingComplete()
	self:reloadSetData()
	...
	ObjectPool.getInstance():newSomeObject(ObjectClassType.type_fish_fnt,lk_system_config.gold_fnt_index,20)
	...
	print("send send_lkby_ReqExchangeAllChips >>>>>>>>>>>>")
end

function Likuipiyu:destoryLoading()
...
function Likuipiyu:loadMusicEffect()
	for k,v in pairs(voice_config) do
		AudioEngine.preloadEffect(v.file)
	end
end

function Likuipiyu:removeMusicEffect()
	AudioEngine.destroyInstance()
end

function Likuipiyu:registerEE()
...
function Likuipiyu:registerMouseEvent()
...
function Likuipiyu:registerUpdate()
...
function Likuipiyu:onEnter()
	--cc.AnimationCache:getInstance():destroyInstance()
end

function Likuipiyu:onExit()
	local scheduler = cc.Director:getInstance():getScheduler()
...
function Likuipiyu:onMouseMove(e)
	-- local local_pos  = e:getLocation()
	-- local global_pos = cc.Director:getInstance():convertToGL(local_pos)
	-- local rect = {x = 0,y = 0,width = lk_system_config.mouse_move_size.width,height= lk_system_config.mouse_move_size.height,}
...
function Likuipiyu:removePicSrc()
...
function Likuipiyu:autoExitScene(dt)
...
function Likuipiyu:isAccessServerMessage()
...
--鱼碰撞回调
function Likuipiyu:onShotCallback(shot_lst)
...
function Likuipiyu:onAutoFire(e)
...
function Likuipiyu:onAutoAddV(e)
	local my_bat_obj = BatteryManager.getInstance():getMyselfBatteryObj()
	if my_bat_obj then
		if e.name == "selected" then
...
function Likuipiyu:setUserInfo(info)
...
--info = {player_id,set_id,is_local,chips,}
function Likuipiyu:setOtherPlayerUserInfo(info)
...
function Likuipiyu:removeSet(setid)
...
function Likuipiyu:isMySet(setid)
	return self.user_info_lst[setid].is_local
end

function Likuipiyu:isAutoExitScene()
	local bat_obj = BatteryManager.getInstance():getMyselfBatteryObj()
	if bat_obj then
...
function Likuipiyu:cutBattery(setid,num,score,power)
...
function Likuipiyu:runSendBullet(setid,bsid,angle)
	local obj = BatteryManager.getInstance():getBatteryBySetId(setid)
...
function Likuipiyu:updateScore(setid,score)
...
function Likuipiyu:fishDeath(setid,fshid,score)
...
function Likuipiyu:fishLstDeath(setid,lst)
...
function Likuipiyu:unLockFish(setid)
	local obj = BatteryManager.getInstance():getBatteryBySetId(setid)
	if obj then
		obj:setUnlockFish()
	end
...
function Likuipiyu:setFishShowLevel(cfg_id,lv)
...
function Likuipiyu:setInsteadPlayerLst(lst)
