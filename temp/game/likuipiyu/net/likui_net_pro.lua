...
require "game.likuipiyu.net.server.rec_parse_lkby"
require "game.likuipiyu.net.server.rec_pro_lkby"
require "game.likuipiyu.net.server.send_lkby"
...
function LikuiNetPro.recEnterGameHallMsg(msg)
	local pinfo 				= get_player_info()
	pinfo.myRoomTypeInfo 		= msg.roomTypes
	pinfo.curGameID 			= 12
	pinfo.curGameDeskClassName 	= "LikuiDesk"
...
function LikuiNetPro.recEnterTableMsg(msg)

	local members 	= msg.mems
	local pinfo 	= get_player_info()
    pinfo.myTableId = members[1].tableId
	
	WindowScene.getInstance():replaceModuleByModuleName("likui")
...
function LikuiNetPro.recOtherPlayerEnterTableMgs(msg)
...
function LikuiNetPro.recExitTableMsg(msg)
...
function LikuiNetPro.recCutBattery(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj then
		obj:cutBattery(msg.battery.order + 1,msg.battery.num,msg.battery.score,msg.battery.power)
	end
...
function LikuiNetPro.recFire(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
...
function LikuiNetPro.recShotFish(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj and obj:isAccessServerMessage() == true then
...
function LikuiNetPro.recChipsChange(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj then
...
function LikuiNetPro.recCutScene(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj and obj:isAccessServerMessage() == true then
...
function LikuiNetPro.recFreshFish(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj and obj:isAccessServerMessage() == true then
...
function LikuiNetPro.recEnterScene(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj then
...
function LikuiNetPro.recLockFish(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj then
...
function LikuiNetPro.recUnLockFish(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj then
...
function LikuiNetPro.recChangeFishLevel(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj then
...
function LikuiNetPro.recInsteadPlayerLst(msg)
	local obj = WindowScene.getInstance():getModuleObjByClassName("Likuipiyu")
	if obj then
		obj:setInsteadPlayerLst(msg.insteadPlayers)
	end
