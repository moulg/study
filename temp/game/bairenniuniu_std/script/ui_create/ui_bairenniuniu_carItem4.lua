...
imgMask:setPosition(1383.0000, 532.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(imgMask)
layout:setPositionPercentX(0.7203)
...
layout:setLeftMargin(1240.0000)
...
nodeCard:setPosition(1382.0000, 300.0000)
...
layout:setLeftMargin(1382.0000)
layout:setRightMargin(-1382.0000)
...
imgCardType:setPosition(1382.0000, 234.0000)
