...
imgMask:setPosition(541.0000, 532.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(imgMask)
layout:setPositionPercentX(0.2818)
...
layout:setRightMargin(1236.0000)
...
nodeCard:setPosition(540.0000, 300.0000)
...
imgCardTypeBG:setPosition(540.0000, 234.0000)
...
layout:setRightMargin(-653.0000)
