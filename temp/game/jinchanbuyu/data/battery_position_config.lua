...
function conversionLocalInfo.getConfig(var)
	...
	if conversionLocalInfo.id == 1 then
		if var == 1 then
			return battery_position_config[3],true
		elseif var == 3 then
			return battery_position_config[1],true
		else
			return battery_position_config[var],false
		end
	elseif conversionLocalInfo.id == 2 then
		if var == 2 then
			return battery_position_config[4],true
		elseif var == 4 then
			return battery_position_config[2],true
		else
			return battery_position_config[var],false
		end
	else
