...
function send_errentexaspoker_ReqEnterRoom(msg)
	local stream = CNetStream()
	stream:writeInt(515102)
...
function send_errentexaspoker_ReqEnterTable(msg)
	local stream = CNetStream()
	stream:writeInt(515103)
...
function send_errentexaspoker_ReqReady(msg)
	local stream = CNetStream()
	stream:writeInt(515104)
...
function send_errentexaspoker_ReqEnterGameHall(msg)
	local stream = CNetStream()
	stream:writeInt(515107)
...
function send_errentexaspoker_ReqFastEnterTable(msg)
	local stream = CNetStream()
	stream:writeInt(515109)
...
function send_errentexaspoker_ReqExitTable(msg)
	local stream = CNetStream()
	stream:writeInt(515110)
...
function send_errentexaspoker_ReqExitRoom(msg)
	local stream = CNetStream()
	stream:writeInt(515113)
...
function send_errentexaspoker_ReqBetDecision(msg)
	local stream = CNetStream()
	stream:writeInt(515114)
...
function send_errentexaspoker_ReqExchangeChips(msg)
	local stream = CNetStream()
	stream:writeInt(515115)
...
function send_errentexaspoker_ReqExchangeGold(msg)
	local stream = CNetStream()
	stream:writeInt(515116)
...
function send_errentexaspoker_ReqDealCardOver(msg)
	local stream = CNetStream()
	stream:writeInt(515118)
...
function send_errentexaspoker_ReqExitGameHall(msg)
	local stream = CNetStream()
	stream:writeInt(515119)
...
function send_errentexaspoker_ReqLightCard(msg)
	local stream = CNetStream()
	stream:writeInt(515120)
...
function send_errentexaspoker_ReqNextStep(msg)
	local stream = CNetStream()
	stream:writeInt(515121)
	
	GetSocketInstance():send(stream)
end


local c2s_errentexaspoker_ReqEnterRoom_msg = 515102 --[[请求进入房间]]
local c2s_errentexaspoker_ReqEnterTable_msg = 515103 --[[请求进入牌桌]]
local c2s_errentexaspoker_ReqReady_msg = 515104 --[[玩家准备]]
local c2s_errentexaspoker_ReqEnterGameHall_msg = 515107 --[[请求进入德州扑克大厅]]
local c2s_errentexaspoker_ReqFastEnterTable_msg = 515109 --[[玩家请求快速进入房间牌桌]]
local c2s_errentexaspoker_ReqExitTable_msg = 515110 --[[玩家请求退出房间牌桌]]
local c2s_errentexaspoker_ReqExitRoom_msg = 515113 --[[玩家请求退出房间牌桌]]
local c2s_errentexaspoker_ReqBetDecision_msg = 515114 --[[玩家操作]]
local c2s_errentexaspoker_ReqExchangeChips_msg = 515115 --[[请求兑换筹码]]
local c2s_errentexaspoker_ReqExchangeGold_msg = 515116 --[[请求兑换金币]]
local c2s_errentexaspoker_ReqFastEnterTable_msg = 515117 --[[请求快速进入牌桌]]
local c2s_errentexaspoker_ReqDealCardOver_msg = 515118 --[[玩家通知服务器发牌结束]]
local c2s_errentexaspoker_ReqExitGameHall_msg = 515119 --[[请求退出德州扑克大厅]]
local c2s_errentexaspoker_ReqLightCard_msg = 515120 --[[玩家请求亮牌]]
local c2s_errentexaspoker_ReqNextStep_msg = 515121 --[[玩家请求下一步操作]]

--[[游戏请求Map]]
gameReqFunMap[15] = {
	ReqEnterRoom=send_errentexaspoker_ReqEnterRoom,
	ReqEnterTable=send_errentexaspoker_ReqEnterTable,
	ReqReady=send_errentexaspoker_ReqReady,
	ReqEnterGameHall=send_errentexaspoker_ReqEnterGameHall,
	ReqFastEnterTable=send_errentexaspoker_ReqFastEnterTable,
	ReqExitTable=send_errentexaspoker_ReqExitTable,
	ReqExitRoom=send_errentexaspoker_ReqExitRoom,
	ReqBetDecision=send_errentexaspoker_ReqBetDecision,
	ReqExchangeChips=send_errentexaspoker_ReqExchangeChips,
	ReqExchangeGolds=send_errentexaspoker_ReqExchangeGold,
	ReqFastEnterTable=send_errentexaspoker_ReqFastEnterTable,
	ReqDealCardOver=send_errentexaspoker_ReqDealCardOver,
	ReqExitGameHall=send_errentexaspoker_ReqExitGameHall,
	ReqLightCard=send_errentexaspoker_ReqLightCard,
	ReqNextStep=send_errentexaspoker_ReqNextStep,
}
