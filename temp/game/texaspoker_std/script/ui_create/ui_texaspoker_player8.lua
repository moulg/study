...
spPlayerBg:setPosition(410.2222, 901.0425)
...
layout:setLeftMargin(295.2222)
layout:setRightMargin(-525.2222)
layout:setTopMargin(-1078.0420)
layout:setBottomMargin(824.0425)
...
imgHeadBg:setPosition(350.1219, 198.1541)
layout = ccui.LayoutComponent:bindLayoutComponent(imgHeadBg)
layout:setPositionPercentX(1.5223)
layout:setPositionPercentY(0.7801)
layout:setSize(cc.size(224.0000, 104.0000))
layout:setLeftMargin(238.1219)
layout:setRightMargin(-232.1219)
layout:setTopMargin(3.8459)
layout:setBottomMargin(146.1541)
...
layout:setPositionPercentX(1.1392)
layout:setPositionPercentY(0.8627)
layout:setSize(cc.size(181.0000, 43.0000))
layout:setLeftMargin(262.0237)
layout:setRightMargin(-213.0237)
layout:setTopMargin(13.3709)
layout:setBottomMargin(197.6291)
...
layout:setLeftMargin(262.0237)
layout:setRightMargin(-194.0237)
layout:setTopMargin(60.7128)
layout:setBottomMargin(150.2872)
...
sprCard0:setPosition(222.0620, 39.0455)
...
layout:setLeftMargin(146.0620)
layout:setRightMargin(-68.0620)
layout:setTopMargin(142.9545)
layout:setBottomMargin(-32.9545)
...
sprCard1:setPosition(218.4699, 51.5823)
...
layout:setLeftMargin(145.9699)
layout:setRightMargin(-60.9699)
layout:setTopMargin(108.9177)
layout:setBottomMargin(-41.9177)
...
sprCard2:setPosition(290.8451, 52.1730)
...
layout:setPercentHeight(0.7362)
layout:setSize(cc.size(145.0000, 187.0000))
layout:setLeftMargin(218.3451)
layout:setRightMargin(-133.3451)
layout:setTopMargin(108.3270)
layout:setBottomMargin(-41.3270)
...
imgReady:setPosition(102.8441, -22.7419)
layout = ccui.LayoutComponent:bindLayoutComponent(imgReady)
layout:setPositionPercentX(0.4471)
layout:setPositionPercentY(-0.0895)
layout:setSize(cc.size(172.0000, 76.0000))
layout:setLeftMargin(16.8441)
layout:setRightMargin(41.1559)
layout:setTopMargin(238.7419)
layout:setBottomMargin(-60.7419)
...
result['animation']:setTimeSpeed(0.9333)
